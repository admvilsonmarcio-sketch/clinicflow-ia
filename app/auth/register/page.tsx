...
export default async function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-green-600 via-emerald-600 to-teal-700">
          ...
          <div className="text-center mt-8">
            ...
            <div className="flex items-center justify-center space-x-8 mt-8">
              <div className="text-center">
                ...
                <div className="text-green-200 text-sm">Médicos</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white">50K+</div>
                <div className="text-green-200 text-sm">Pacientes</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white">1M+</div>
                <div className="text-green-200 text-sm">Consultas</div>
              </div>
            </div>
          </div>
        </div>
